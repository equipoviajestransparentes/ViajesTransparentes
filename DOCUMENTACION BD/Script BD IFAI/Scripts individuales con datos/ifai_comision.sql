...
CREATE TABLE `comision` (
  ...
  `COMPROBADO_TOTAL` decimal(2,0) DEFAULT NULL COMMENT 'Campo que indica el monto comprobado total de la comision asignada al servidor publico',
  `SIN_COMPROBAR_TOTAL` decimal(2,0) DEFAULT '0' COMMENT 'Campo que indica el monto sin comprobado total de la comision asignada al servidor publico',
  `VIATICO_DEVUELTO_TOTAL` decimal(2,0) DEFAULT '0' COMMENT 'Campo que indica el monto de viaticos total devuelto por el servidor publico',
