...
--
-- Table structure for table `concepto_catalogo`
--

DROP TABLE IF EXISTS `concepto_catalogo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `concepto_catalogo` (
  `idConcepto` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Llave identificadora del concepto',
...
--
-- Dumping data for table `concepto_catalogo`
--

LOCK TABLES `concepto_catalogo` WRITE;
