...
# sql_comision = File.read('db/Scripts/comision1.sql')
...
#  end
# #############Viaje######
# sql_Viaje = File.read('db/Scripts/viaje1.sql')
...
# ##################Detalle Viaje###################
# sql_detViaje = File.read('db/Scripts/detalleviaje1.sql')
...
#####################################################
######################Vuelo##########################
 sql_vuelo = File.read('db/Scripts/vuelo1.sql')
...
#######################Costo##########################
 sql_costo = File.read('db/Scripts/costo1.sql')
...
#####################################################
########################Gasto########################
 sql_gasto = File.read('db/Scripts/gasto1.sql')
