...
#############################################
################# SERVIDOR ###############
#ql_servidor = File.read('db/Scripts/ifai_servidor_publico.sql')
#tat_servidor = sql_servidor.split(/;/)
#tat_servidor.pop
#
...
#
######################### TIPO PERSONAL ###########################################
#ql_tipo_personal = File.read('db/Scripts/ifai_tipo_personal_catalogo.sql')
...
#
################## MONEDA ###############
#ql_moneda = File.read('db/Scripts/ifai_moneda_catalogo.sql')
...
#
################## Tema viaje ###############
#ql_tema_viaje = File.read('db/Scripts/ifai_tema_de_viaje_catalogo.sql')
